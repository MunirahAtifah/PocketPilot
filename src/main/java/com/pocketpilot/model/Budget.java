...
/**
 * Budget - Model class representing a budget entity
 * 
 * Purpose: Encapsulates budget data and provides getters/setters
 * 
 * Attributes:
 *   - budgetID: Unique identifier for budget (auto-generated by database)
 *   - studentID: Student who owns this budget
 *   - categoryID: Category of the budget (e.g., School, Transport)
 *   - budgetAmount: The budgeted amount (in currency units)
 *   - budgetDesc: Description/name of the budget
 *   - budgetDate: Date the budget was created
 *   - categoryName: Name of the category (loaded from Category table)
 * 
